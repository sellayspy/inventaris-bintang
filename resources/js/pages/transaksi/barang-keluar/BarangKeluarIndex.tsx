...
export default function BarangKeluarIndex() {
    const { filters, barangKeluar, kategoriOptions, lokasiOptions } = usePage<PageProps>().props;
        ...
        <AppLayout>
            <div className="p-6">
                <div className="mb-4 flex items-center justify-between">
                    ...
                    <Link href="/barang-keluar/create" className="rounded bg-green-600 px-4 py-2 text-sm text-white hover:bg-green-700">
                ...
                >
                    ...
                    <div>
                        <label className="mb-1 block text-sm">Tujuan Distribusi</label>
                    ...
                    <table className="min-w-full border-collapse text-sm">
                        ...
                        <tbody>
                            {barangKeluar.data.length === 0 ? (
                                ...
                                barangKeluar.data.map((item, idx) => (

        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="p-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Lokasi</h1>
                    <button
                        onClick={() => {
                            if (showForm) {
                                handleCancel();
                ...
                {showForm && (
                    <div className="mb-6 rounded-lg bg-white p-6 shadow-md ring-1 ring-gray-100 dark:bg-zinc-900 dark:text-white">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                {form.errors.alamat && <div className="mt-1 text-sm text-red-600">{form.errors.alamat}</div>}
                            </div>

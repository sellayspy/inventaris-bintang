            ...
            <div className="p-6">
                ...
                {showForm && (
                    <div className="mb-6 rounded-lg bg-white p-6 shadow dark:bg-zinc-900">
                        <h2 className="mb-4 text-xl font-semibold dark:text-white">{editing ? 'Edit Kategori' : 'Tambah Kategori Baru'}</h2>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                        <thead className="bg-gray-100 dark:bg-zinc-800">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium uppercase">Nama Kategori</th>

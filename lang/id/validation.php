...
return [
    ...
    'custom' => [
        'items.*.serial_numbers.*.distinct' => 'Setiap Serial Number yang dimasukkan harus unik dan tidak boleh sama.',
        'items.*.serial_numbers.*.unique' => 'Serial Number ini sudah terdaftar di sistem.'
    ],
    'attributes'             => [
        'address'                  => 'alamat',
        ...
        'year'                     => 'tahun',
        //custom
        'items.*.serial_numbers.*' => 'Serial Number',
        'items.*.keluar_info.*.serial_number' => 'Serial Number',
        'items.*.merek'           => 'Merek',
        'items.*.model'           => 'Model',
        'items.*.kategori'        => 'Kategori',
        'items.*.jenis_barang'   => 'Jenis Barang',
    ],
];
